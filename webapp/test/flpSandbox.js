		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Treinamento Fiori",
									"targetURL": "#ui5treinamento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5treinamento-display": {
								"semanticObject": "ui5treinamento",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5treinamento",
									"url": sap.ui.require.toUrl("ui5treinamento")
								}
							}
						}
					}
